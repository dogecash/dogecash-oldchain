...
In order to support loading of multiple wallets in trttium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trttium.cpp.
...
Changes to trttium.cpp
----------------------
trttium.cpp is the entry point into trttium-qt, and as such, will require some minor modifications to provide hooks for
