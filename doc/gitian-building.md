...
- [Building Trttium](#building-trttium)
...
./bin/gbuild --commit trttium=${COMMIT} --url trttium=${URL} ../Trttium/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit trttium=${COMMIT} --url trttium=${URL} ../Trttium/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit trttium=${COMMIT} --url trttium=${URL} ../Trttium/contrib/gitian-descriptors/gitian-osx.yml
```
