Contributing to Trittium Core
============================

The Trittium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trittium Core project, and is not to be
confused with overall Trittium Network Protocol consensus changes.

Whether a pull request is merged into Trittium Core rests with the project merge
...
Patches that change Trittium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trittium consensus, it must have been
...
The project leader is the release manager for each Trittium Core release.
