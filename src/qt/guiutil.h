...
/** Utility functions used by the Trittium Qt UI.
 */
namespace GUIUtil
{
...
// Render Trittium addresses in monospace font
...
// Parse "trittium:" URI into recipient object, return true on successful parsing
