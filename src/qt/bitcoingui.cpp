                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Trittium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trittium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trittium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTRTT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trittium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trittium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trittium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trittium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trittium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Trittium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trittium Core help message to get a list with possible Trittium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trittium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trittium network", "", count));
}
...
{
    QString strTitle = tr("Trittium Core"); // default title
