                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Trittium from zTrittium"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTrittium"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTrittium));
